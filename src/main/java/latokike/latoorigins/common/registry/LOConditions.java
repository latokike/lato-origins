...
public class LOConditions {
	private static final Map<ConditionFactory<LivingEntity>, Identifier> ENTITY_CONDITIONS = new LinkedHashMap<>();
	
	public static final ConditionFactory<LivingEntity> PIGLIN_SAFE = createEntityCondition(new ConditionFactory<>(new Identifier(LatoOrigins.MODID, "piglin_safe"), new SerializableData(), (instance, playerEntity) -> playerEntity.world.getDimension().isPiglinSafe()));
